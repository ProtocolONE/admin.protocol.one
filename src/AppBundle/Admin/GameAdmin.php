...
class GameAdmin extends AbstractAdmin
{
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ...
            ->tab('Social')
            ->with('Social groups')
            ->add('facebookGroupUrl', TextType::class, ['required' => false])
            ->add('twitterGroupUrl', TextType::class, ['required' => false])
            ->add('youTubeGroupUrl', TextType::class, ['required' => false])
            ->add('googlePlusGroupUrl', TextType::class, ['required' => false])
            ->add('vkGroupUrl', TextType::class, ['required' => false])
            ->add('odnoklassnikiGroupUrl', TextType::class, ['required' => false])
            ->add('moimirGroupUrl', TextType::class, ['required' => false])
            ->end()
            ->end()
            ->tab('Images')
